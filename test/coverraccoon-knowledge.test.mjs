...
const entries = parseKnowledgeResponse({ apiVersion: 'agent-knowledge.v1', entries: [
	{ id: 'nexus.overview', title: 'Overview', content: 'Nexus Mutual overview content.', sourceUrl: 'https://coverraccoon.com/cover/nexus-mutual', updatedAt: '2026-07-14', origin: 'mixed' },
	{ id: 'nexus.claims', title: 'Claims', content: 'Claims committee and payouts.', sourceUrl: 'https://coverraccoon.com/cover/nexus-mutual/claims', updatedAt: '2026-07-14', origin: 'mixed' }
] });
